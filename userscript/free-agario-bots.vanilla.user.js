...
<div id="settings" class="inputs-menu active"></div>
    ...
    <input type="password" id="botsRemoteIP" placeholder="ws://localhost:8083" maxlength="100" spellcheck="false">
...
function setGUIEvents() {
    ...
    document.getElementById('gbutton').addEventListener('click', () => {
	    ...
	    swal("Redirect", "Please Wait", "success",{buttons: false,timer: 3000,closeOnEsc: false,closeOnClickOutside: false,showConfirmation: false,});$('rbutton')
	})
